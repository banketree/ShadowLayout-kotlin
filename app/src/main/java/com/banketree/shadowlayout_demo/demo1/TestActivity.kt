package com.banketree.shadowlayout_demo.demo1
...
import com.banketree.shadowlayout_demo.R
import com.banketree.shadowlayout_demo.view.ColorPickerView
...
class TestActivity : AppCompatActivity(), SeekBar.OnSeekBarChangeListener {
    ...
    private var shadowConfig: IShadow?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shadowConfig = shadowLayout.getShadowConfig()
        initView()
    }
